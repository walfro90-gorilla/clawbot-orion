...
- **Extensión Orion Sync**: `v0.10.13` (manifest) — 0.10.12 re-activó el focus-hack SOLO para search (regresión SalesNav); 0.10.13 añade `get_contact_info` (digest diario). Anti-ban: piso de invite por-cuenta (scheduler); focus-hack OFF para invite/FU/inbox. ⚠️ verificar versión real con `linkedin_accounts.ext_version` — el disco de cada máquina puede ir atrás.
