...
- **Extensión Orion Sync**: `v0.10.11` (manifest) — company-scoped endurecido + focus-hack OFF. Anti-ban: piso de invite por-cuenta (scheduler) + focus-hack removido. ⚠️ verificar versión real con `linkedin_accounts.ext_version` — el disco de cada máquina puede ir atrás.
