    ...
    try {
      ...
      if (leadId) {
        if (!isError && result?.status === 'withdrawn') {
          ...
          // ⚠️ NO clasificar "Conectar visible" como invite expirada: el sidebar
          // "Más perfiles para ti" trae botones Conectar de gente sugerida (falso
          // positivo visto 14-ago). pending_button_not_found real = cooldown y ya.
