    ...
    <>
      ...
      <div className="sm:hidden fixed top-0 left-0 right-0 z-40 h-12 flex items-center px-4 bg-gray-900 border-b border-gray-800">
        ...
        <span className="ml-3 text-white font-bold text-sm">
          ...
          <span className="text-gray-500 font-normal text-xs ml-1.5">CRM LinkedIn</span>
        </span>
      ...
      {/* ── Desktop sidebar ─────────────────────────────────────────────────────── */}
      <aside data-tour="sidebar" className="hidden sm:flex w-56 shrink-0 flex-col bg-gray-900 border-r border-gray-800 min-h-screen">
        {/* Logo */}
