...
const STAGE_LABELS: Record<string, { label: string; icon: string; color: string }> = {
  ...
  follow_up_sent:       { label: "FU1",          icon: "📨", color: "text-cyan-400" },
  follow_up_sent_2:     { label: "FU2",          icon: "📩", color: "text-cyan-400" },
  follow_up_sent_3:     { label: "FU3",          icon: "📬", color: "text-cyan-400" },
  follow_up_sent_4:     { label: "FU4",          icon: "📮", color: "text-cyan-400" },
  follow_up_sent_5:     { label: "FU5",          icon: "🔔", color: "text-cyan-400" },
